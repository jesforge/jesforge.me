        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] text-base mx-12 font-light dark:text-white text-gray-900">
            <p className="mt-6 mb-12 font-normal">
              ...
              my goal is always to give 100% to my projects and to keep
              improving them with new features, updates and events. I put my
              heart into it and always try to do my best. I also do well in a
              team. I have been in development and programming since 2022, as I
              have been since 2021 with my first project.{" "}
              <span className="inline-flex items-baseline">
                <Image
                  src={Sparkles}
                  alt="rocket"
              ...
              Experience in React.js, Next.js, and state management like i have
              experience in many languages and tools i love to find and do new
              things so that you have a broad “knowladge base” and can work with
              it as well as continue to learn and work on yourself.{" "}
              <span className="inline-flex items-baseline">
                <Image
                  src={Flash}
                  alt="rocket"

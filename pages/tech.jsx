  ...
  const data = [
    {
      title: "VS Code",
      id: 0,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vscode/vscode-original.svg",
    ...
    },
    {
      title: "JavaScript",
      id: 1,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/javascript/javascript-original.svg",
    ...
    },
    {
      title: "TypeScript",
      id: 2,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/typescript/typescript-original.svg",
    ...
    },
    {
      title: "React JS",
      id: 3,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg",
    ...
    },
    {
      title: "Next JS",
      id: 4,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nextjs/nextjs-original.svg",
    ...
    },
    {
      title: "Tailwind CSS",
      id: 5,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg",
    ...
    },
    {
      title: "Portainer",
      id: 6,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/portainer/portainer-original.svg",
      desc: "A lightweight management UI which allows you to easily manage your Docker host or Kubernetis cluster.",
      tag: "develop",
      bg: "bg-indigo-50",
    ...
    },
    {
      title: "Gitlab",
      id: 7,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/gitlab/gitlab-original-wordmark.svg",
      desc: "A web-based DevOps lifecycle tool that provides a Git-repository manager providing wiki, issue-tracking and CI/CD pipeline features.",
      tag: "design",
      bg: "bg-pink-300",
      text: "text-pink-800",
    },
    {
      title: "Cloudflare",
      id: 8,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/cloudflare/cloudflare-original.svg",
    ...
    },
    {
      title: "GitHub",
      id: 9,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original.svg",
    ...
    },
    {
      ...
      id: 10,
      main: "https://nginxproxymanager.com/logo.svg",
      desc: "A simple way to manage your Nginx proxy hosts. And Reverse Proxy with a simple, powerful interface.",
      tag: "platform",
      bg: "bg-orange-500",
    ...
    },
    {
      title: "Kotlin",
      id: 11,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/kotlin/kotlin-original.svg",
      desc: "The Better Java. Concise. Multiplatform. Fun. by JetBrains.",
      tag: "kotlin",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "C#",
      id: 12,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/csharp/csharp-original.svg",
      desc: "A general-purpose, multi-paradigm programming language developed by Microsoft.",
      tag: "c#",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Hetzner",
      id: 13,
      main: "https://www.hetzner.com/_resources/themes/hetzner/images/logo/hetzner-logo.svg",
      desc: "A German Server Hosting Company, providing VPS, Dedicated Servers, Cloud Hosting and more.",
      tag: "hosting",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "MongoDB",
      id: 14,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mongodb/mongodb-original-wordmark.svg",
      desc: "A general-purpose, document-based, distributed database built for modern application developers and for the cloud era.",
      tag: "database",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "SQl",
      id: 15,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/azuresqldatabase/azuresqldatabase-original.svg",
      desc: "SQL is a standard language for accessing and manipulating databases.",
      tag: "database",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Gradle",
      id: 16,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/gradle/gradle-original.svg",
      desc: "A build automation tool that is open-source and build tool for the JVM.",
      tag: "build",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Discord.js",
      id: 17,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/discordjs/discordjs-original.svg",
      desc: "A powerful library for interacting with the Discord API.",
      tag: "discord",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Express JS",
      id: 18,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/express/express-original-wordmark.svg",
    ...
    },
    {
      title: "markdown",
      id: 19,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/markdown/markdown-original.svg",
    ...
    },
    {
      title: "Moonlight",
      id: 20,
      main: "/icons/moonlight.png",
      desc: "Moonlight brings new life into the game panel world. It comes with a fast and responsive ui and an efficient backend to give you more control over the services you are hosting",
      tag: "hosting",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "jetbrains",
      id: 21,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/jetbrains/jetbrains-original.svg",
      desc: "JetBrains is a software development company whose tools are targeted towards software developers and project managers.",
      tag: "jetbrains",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Swagger",
      id: 22,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/swagger/swagger-original.svg",
      desc: "A set of open-source tools built around the OpenAPI Specification that can help you design, build, document and consume REST APIs.",
      tag: "swagger",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Unreal Engine",
      id: 23,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/unrealengine/unrealengine-original-wordmark.svg",
      desc: "A game engine developed by Epic Games, first showcased in the 1998 first-person shooter game Unreal.",
      tag: "ue",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
    {
      title: "Laravel",
      id: 24,
      main: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/laravel/laravel-original.svg",
      desc: "A free, open-source PHP web framework, created by Taylor Otwell and intended for the development of web applications following the model–view–controller architectural pattern.",
      tag: "laravel",
      bg: "bg-orange-500",
      text: "text-orange-100",
    },
